"""Binary protection resource commands."""
...
APP_NAME = "protection"
APP_HELP = "Binary protection findings (RELRO, stack canaries, etc.)."


def register(app: typer.Typer) -> None:
    app.command("list")(list_protections)
...
def list_protections(
    ...
    """List binary protections for an asset."""
    aid = resolve_asset_id(asset_id, asset=asset)
    run_list(
        ctx,
        method_name="iter_binary_protections",
        asset_id=aid,
